...
import { loginUserByGmailController, loginUserController, registrationUserController } from '../controllers/userController.js'
...
routes.post("/login/gmail",loginUserByGmailController)
